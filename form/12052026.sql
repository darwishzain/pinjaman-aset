...
--
-- Host: localhost
-- Generation Time: May 12, 2026 at 10:17 AM
...
CREATE TABLE `T1_user` (
  ...
  `T1_role` enum('user','admin','pic') NOT NULL DEFAULT 'user'
...
CREATE TABLE `T2_asset` (
  ...
  `T2_handlerid` varchar(50) NOT NULL COMMENT 'userid of handler',
...
CREATE TABLE `T3_request` (
  ...
  `T3T1_userid` varchar(50) NOT NULL,
  `T3_submittime` datetime NOT NULL,
  `T3_reason` text NOT NULL,
  `T3_remark` varchar(255) NOT NULL,
  `T3_usage` varchar(30) NOT NULL,
  `T3_type` varchar(30) NOT NULL,
  `T3_approval` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL CHECK (json_valid(`T3_approval`)),
  `T3_status` varchar(40) NOT NULL,
  `T3_details` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL CHECK (json_valid(`T3_details`))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
ALTER TABLE `T2_asset`
  ...
  ADD KEY `asset_handler` (`T2_handlerid`);
...
--
ALTER TABLE `T2_asset`
  ADD CONSTRAINT `asset_handler` FOREIGN KEY (`T2_handlerid`) REFERENCES `T1_user` (`T1_userid`);
